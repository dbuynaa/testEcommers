...
const Col = ({ children, title, titleClass = 'pb-4' }: { children: React.ReactNode; title: string; titleClass?: string }) => (
...
const Footer = ({ metaData }: any) => {
  ...
  if (router.asPath.includes('auth') || router.asPath.includes('checkout')) return null;
        ...
        <div className="container pt-5 pb-3 relative">
          <div className="row">
            <Col title="Бидний тухай">
              ...
              <FooterLink href="https://www.zangia.mn/company/JC-electronics">Ажлын байр</FooterLink>
              <FooterLink href="/branches">Салбарууд</FooterLink>
            </Col>
            <Col title="ТУСЛАМЖ">
              <FooterLink href="/terms-of-service">Үйлчилгээний нөхцөл</FooterLink>
